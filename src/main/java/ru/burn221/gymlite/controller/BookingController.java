...
public class BookingController {
    ...
    public ResponseEntity<Page<BookingResponse>> getAllByUser(@PathVariable String userName, Pageable pageable){
        Page<BookingResponse> page= bookingService.getBookingByUser(userName,pageable);

        return ResponseEntity.ok(page);
    }

    @GetMapping("/by-equipment-and-time-period/{equipmentId}/{startTime}/{endTime}")
    ...
    public ResponseEntity<Page<BookingResponse>> getAllByequipment(@PathVariable Integer equipmentId,Pageable pageable){
